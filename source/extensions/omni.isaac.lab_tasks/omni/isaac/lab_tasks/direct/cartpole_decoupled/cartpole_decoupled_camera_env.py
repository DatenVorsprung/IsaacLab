...
class CartpoleDecoupledRGBCameraEnvCfg(DirectRLEnvCfg):
    ...
    # robot
    robot_cfg: ArticulationCfg = CARTPOLE_DECOUPLED_CFG.replace(prim_path="/World/envs/env_.*/Robot")
...
@configclass
class CartpoleDecoupledDepthCameraEnvCfg(CartpoleDecoupledRGBCameraEnvCfg):
    # camera
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
        prim_path="/World/envs/env_.*/Camera",
        offset=TiledCameraCfg.OffsetCfg(pos=(-7.0, 0.0, 3.0), rot=(0.9945, 0.0, 0.1045, 0.0), convention="world"),
...
class CartpoleDecoupledCameraEnv(DirectRLEnv):
    ...
    cfg: CartpoleDecoupledRGBCameraEnvCfg | CartpoleDecoupledDepthCameraEnvCfg

    def __init__(
        self, cfg: CartpoleDecoupledRGBCameraEnvCfg | CartpoleDecoupledDepthCameraEnvCfg, render_mode: str | None = None, **kwargs
    ):
